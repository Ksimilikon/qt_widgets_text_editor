    ...
    : QWidget(parent)
{
    ...
    m_textColor->setText("#000");
    m_textColor->setValidator(colorValidator);

    m_bgColor = new QLineEdit();
    m_bgColor->setText("#ffffff");
    m_bgColor->setValidator(colorValidator);
...
void StyleForm::setProperties(){
    ...
    m_bgColor->setText(props.bgColor.name(QColor::HexRgb));
...
void StyleForm::slotSwitchMain(){
    QRegularExpression colorCheck("#[0-9A-Fa-f]{6}");
